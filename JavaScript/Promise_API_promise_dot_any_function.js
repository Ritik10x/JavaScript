...
// promise.any will wait for your sucess or fulffiled promise to settled 
// if there is any rejeted promise still it will only wait for fulffiled promise
// in simple it will only givee us succesful settled promise
Promise.any([P1,P2,P3]) // whatever this promise api will fetch will go insidie this.then
