...
})// we can use catch for hadnle just the first function error to if occurs firstly 
// just put the catch there
.then(function(orderId)// this function will be called coz i attached
{
    console.log("no matter what happen it will be called");
})
