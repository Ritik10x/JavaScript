...
// promise .race will go and give result whateever comes first either fail or sucess
// its like  race whatever comes first will give
Promise.race([P1,P2,P3]) // whatever this promise api will fetch will go insidie this.then
