 // differnce b/w async await and old promise handler
...
async function handlePromise() {    
    const val = await p;// await will wait here to promise to resolve after that it will
    console.log("NamsteJavaScript");// got to next line, in old method it didnt work like that 
    console.log(val);// javascript is waiting  in const val = await p; here 
}
